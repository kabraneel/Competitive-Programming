...
1. Assiocative merging function - sum, __gcd()
2. An applying function for the update -> how the node value will be modified
3. How to combine two updates. A combining function.
4. We can have different data.
