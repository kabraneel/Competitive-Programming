...
void solve(){
	...
	map<string,vector<int>> M31;
	map<string,vector<int>> M32;
	map<string,vector<int>> M33;

	map<string,vector<int>> M21;
	map<string,vector<int>> M22;
